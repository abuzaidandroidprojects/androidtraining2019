...
import com.example.androidtraining2019.Utils.TaskLoader;
import com.example.androidtraining2019.Utils.Utils;

public class LoadImageActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Bitmap> {
    ...
    public void loadFromLoader(View view) {
        ...
        if (Utils.isDeviceConnectedInternet(this))
            getSupportLoaderManager().initLoader(0, dataBundle, this).forceLoad();
        else
